          ...
          d &&
            ...
            (g.destroy = function (e) {
              Z(!1, "internal"),
                ...
                le(!1),
                Nn(d, Yt),
                [w, b, l, O, M, C, S, P].forEach(function (e) {
                  clearTimeout(e);
                }),
      ...
      function Le() {
        ...
        if (!T && (!E.autoScrolling || E.scrollBar)) {
          ...
          if (
            ...
            w && ((p = w.getAttribute("data-anchor")), (v = In(w))),
              k &&
                (Nn(e, Xt),
                zn(Xn(e), Xt),
        ...
        if (null != e) {
          ...
          if (
            ...
            E.autoScrolling &&
              ...
              (k = g.test.isTesting),
              wt(f, u, d.anchorLink, d.sectionIndex),
              (function (e) {
          ...
          !1 === Ne("onSlideLeave", l)
            ...
            : (Nn(t, Xt),
              ...
              !E.loopHorizontal &&
                ...
                Qn(yn(bn, i), null != Cn(t))),
              Ln(i, Xt) &&
                !l.localIsResizing &&
                wt(l.slideIndex, l.slideAnchor, l.anchorLink, l.sectionIndex),
              (function (e, t, n) {
                var o = t.destinyPos;
                if (E.css3) {
                  var r =
      ...
      function Ct() {
        ...
        n
          ...
          : (wn(
            ...
            wn("error", "https://github.com/alvarotrigo/fullPage.js#options")),
          Ln(u, Ft)
            ? wn(
                "error",
